	...
	<div class="wrapper">
		...
		<div class="user-info">
			...
			<el-badge :value="unReadTotal" class="item" >
			  	<span class="new-msg" id="advices" @click.prevent = "messageShow"><i class="icon iconfont icon-tixing"></i></span>
			</el-badge>
		...
		<header class="message-title">
			...
			<div class="title-wrapper clearfix">
				...
				<div class="notice">
					...
					<ul class="ms-type" id="noticeType">
						<li><a href="javacript:;" class="notice-type" @click.prevent="filterAll()"><span class="font">通知</span></a></li>
						...
						<li><a href="javacript:;" class="notice-type" @click.prevent="filterRead"><span class="font">已读消息</span></a></li>
					</ul>
				</div>
			...
			<div class="message-wrapper">
							...
							<div class="send-content">
								<div class="intro">
									<span class="msg-type" v-if="item.isRead == 0">
										<el-badge is-dot class="item">【{{item.type}}】</el-badge>
									</span>
				...
				<div class="message-content">
					<div class="content-panel" v-if="detailsNoticeData != null">
						<div class="msg-correlation">
							<span class="sender">【{{detailsNoticeData.type}}】</span>
							<span class="sender">{{detailsNoticeData.author}}</span>
							<span class="send-time">{{detailsNoticeData.createTime}}</span>
						</div>
						<div class="msg-content">
							{{detailsNoticeData.context}}
						</div>
					</div>
				</div>
			</div>
