<template>
	<div class="table">
      ...
      <el-table-column prop="memberName" label="购买人">
      	 <template slot-scope="scope">
          <span>{{scope.row.memberName}}&nbsp;</span>
        </template>
      </el-table-column>
      <!--<el-table-column prop="phone" label="手机号"></el-table-column>-->
      <el-table-column prop="averageFee" label="费用">
        <template slot-scope="scope">
          <span>
					 {{scope.row.averageFee}}元/1课时
					</span>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="classNumber" label="时间">
        <template slot-scope="scope">
          <span v-if="scope.row.classNumber == 0">已确认</span>
