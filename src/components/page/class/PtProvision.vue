<template>
  <div class="table">
    ...
    <el-form :inline="true" :model="listQuery" class="demo-form-inline">
      ...
      <el-form-item>
        <el-select v-model="listQuery.classStatus" placeholder="全部课程" :clearable=true @change="getData">
      ...
      <el-dialog :visible.sync="addFormVisible" title="添加私教课程" width="600px" :before-close="handleClose" :closeOnClickModal="false">
        <el-form ref="addForm" :model="addForm" label-width="120px" :rules="addRules" class="form-container">
          ...
          <el-form-item label="课程状态" prop="classStatus">
            <el-select v-model="addForm.classStatus" placeholder="请选择状态">
              <el-option v-for="item in statusData" :key="item.id" :label="item.value" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="课程单价" prop="classPrice">
    ...
    <div class="panel">
      <el-dialog :visible.sync="editFormVisible"  title="编辑私教课程" width="600px" :closeOnClickModal="false">
        <el-form ref="editForm" :model="editForm" label-width="120px" :rules="editRules"  class="form-container">
          ...
          <el-form-item label="课程状态" prop="classStatus">
            <el-select v-model="editForm.classStatus" placeholder="请选择状态">
              <el-option v-for="item in statusData" :key="item.id" :label="item.value" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="课程单价" prop="classPrice">
          ...
          <el-form-item label="注意事项" prop="classNotice">
             <el-input v-model="editForm.classNotice" type="textarea"></el-input>
          </el-form-item>
          <el-form-item>
