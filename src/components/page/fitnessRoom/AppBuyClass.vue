  ...
  <div class="table">
    ...
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>未度购买课程</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      getTotal() {
        this.$axios({
          url: this.path + 'class/personal/countList',
          method: 'get',
      ...
      getData() {
        ...
        this.$axios({
          url: this.path + 'class/personal/orderList',
          method: 'get',
          params: this.listQuery,
          transformRequest: [function (params) {
            let ret = ''
          ...
          if (res.data.code === 100000) {
            ...
            this.getCoach();
            this.getType();
            this.tableData = res.data.erpPersonalClassBeans;
