  ...
  <div class="table">
    ...
    <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="筛选条件">
          ...
          <el-select v-model="listQuery.kindId" placeholder="选择会员卡名称" :clearable=true @change="handleFilter">
      ...
      <el-form-item label="余额筛选" v-else>
        ...
        <el-form-item label="生效日期">
          <el-date-picker :picker-options="pickerOptions1" v-model="ActivateTime" type="daterange" range-separator="至" start-placeholder="开始日期" :editable=true end-placeholder="结束日期" value-format="yyyy-MM-dd" :clearable=true @change="handleFilter">
          </el-date-picker>
        </el-form-item>
        <br />
        <el-form-item label="失效日期">
          <el-date-picker :picker-options="pickerOptions1" v-model="LoseTime" type="daterange" range-separator="至" start-placeholder="开始日期" :editable=true end-placeholder="结束日期" value-format="yyyy-MM-dd" :clearable=true @change="handleFilter">
          </el-date-picker>
        </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleExport(){
        this.downloadUrl = this.path + 'erp/card/table/excel?kindId='+this.listQuery.kindId
          +'&kindType='+this.listQuery.kindType
          +'&startTime='+this.listQuery.startTime
          +'&endTime='+this.listQuery.endTime
          +'&minNum='+this.listQuery.minNum
          +'&maxNum='+this.listQuery.maxNum
          +'&startLoseTime='+this.listQuery.startLoseTime
          +'&endLoseTime='+this.listQuery.endLoseTime;
        ...
        xhr.onload = function (e) {
          if (this.status == 200) {
            ...
            link.download = year+month+dates+'会员卡报表.xls';
            link.click()
          } else {
