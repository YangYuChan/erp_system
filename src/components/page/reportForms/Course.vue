...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleExport(){
        this.downloadUrl = this.path + 'erp/class/table/excel?kind='+this.listQuery.kind+'&coachId='+this.listQuery.coachId+'&startTime='+this.listQuery.startTime+'&endTime='+this.listQuery.endTime;
        ...
        xhr.onload = function (e) {
          if (this.status == 200) {
            ...
            link.download = year+month+dates+'课程报表.xls';
            link.click()
          } else {
