		...
		<el-form :inline="true" :model="listQuery" class="demo-form-inline">
			...
			<br />
				<el-form-item label="筛选条件">
						<el-select v-model="listQuery.level" placeholder="员工权限"  :clearable=true @change="getData">
							<el-option v-for="item in powerList" :key="item.id" :label="item.value" :value="item.id"></el-option>
						</el-select>
					</el-form-item>
					<el-form-item>
						<el-select v-model="listQuery.status" placeholder="在职状态"  :clearable=true @change="getData">
